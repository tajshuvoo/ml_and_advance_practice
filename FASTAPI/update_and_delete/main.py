...
def view_patient(patient_id: str= Path(..., description='Id of the patient in the dbms', example='P001')):
    data = load_data()
...
def update_patient(patient_id:str , patient_update: PatientUpdate):
    ...
    return JSONResponse(status_code=201, content={'message':'Patient info updated!'})
